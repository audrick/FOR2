...
u12 = User.create(:first_name => "Heidi", :last_name => "Klum", :username => "hklum", :email_address => "kimshees@gmail.com", :password => "123", :password_confirmation => "123", :zip_code => "11375", :phone_number => "9176789036", :gender => "female", :birthday => "", :buyer_fresh_preference => "same day", :buyer_distance_preference => "2", :has_allergies => "f", :seller_distance_preference => "", :seller_delivery_preference => "", :seller_pickup_preference => "", :is_seller => "t")
u13 = User.create(:first_name => "Scott", :last_name => "Johnson", :username => "sjohn", :email_address => "kimshees@gmail.com", :password => "123", :password_confirmation => "123", :zip_code => "11005", :phone_number => "9176789036", :gender => "male", :birthday => "", :buyer_fresh_preference => "same day", :buyer_distance_preference => "2", :has_allergies => "f", :seller_distance_preference => "", :seller_delivery_preference => "", :seller_pickup_preference => "", :is_seller => "t")
...
u18 = User.create(:first_name => "Kevin", :last_name => "Jonas", :username => "kjonas", :email_address => "kimshees@gmail.com", :password => "123", :password_confirmation => "123", :zip_code => "11362", :phone_number => "9176789036", :gender => "male", :birthday => "", :buyer_fresh_preference => "same day", :buyer_distance_preference => "2", :has_allergies => "f", :seller_distance_preference => "", :seller_delivery_preference => "", :seller_pickup_preference => "", :is_seller => "t")
u19 = User.create(:first_name => "Henry", :last_name => "Simons", :username => "hsimons", :email_address => "kimshees@gmail.com", :password => "123", :password_confirmation => "123", :zip_code => "11416", :phone_number => "9176789036", :gender => "male", :birthday => "", :buyer_fresh_preference => "same day", :buyer_distance_preference => "2", :has_allergies => "f", :seller_distance_preference => "", :seller_delivery_preference => "", :seller_pickup_preference => "", :is_seller => "t")
u20 = User.create(:first_name => "Emeril", :last_name => "Lagasse", :username => "elagasse", :email_address => "kimshees@gmail.com", :password => "123", :password_confirmation => "123", :zip_code => "11225", :phone_number => "9176789036", :gender => "male", :birthday => "", :buyer_fresh_preference => "same day", :buyer_distance_preference => "5", :has_allergies => "t", :seller_distance_preference => "", :seller_delivery_preference => "", :seller_pickup_preference => "", :is_seller => "t")
...
u22 = User.create(:first_name => "Carmelo", :last_name => "Anthony", :username => "cathony", :email_address => "kimshees@gmail.com", :password => "123", :password_confirmation => "123", :zip_code => "10280", :phone_number => "9176789036", :gender => "male", :birthday => "", :buyer_fresh_preference => "same day", :buyer_distance_preference => "5", :has_allergies => "t", :seller_distance_preference => "", :seller_delivery_preference => "", :seller_pickup_preference => "", :is_seller => "f")
